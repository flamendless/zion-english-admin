...
var (
	...
	ErrFileTooLarge          = errors.New("[INTRO VIDEO] file too large")
	...
	ErrTooLong               = errors.New("[INTRO VIDEO] video too long")
	ErrFfprobeUnavailable    = errors.New("[INTRO VIDEO] ffprobe unavailable")
	ErrFfmpegUnavailable     = errors.New("[INTRO VIDEO] ffmpeg unavailable")
	ErrCompressFailed        = errors.New("[INTRO VIDEO] Failed to process video")
)
