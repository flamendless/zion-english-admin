...
func RegisterTeacher(loggedIn bool, role auth.Role) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/register_teacher.templ`, Line: 22, Col: 97}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var4)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\" hx-target=\"#logOutput\"><div class=\"form-row-3\"><div class=\"form-group\"><label for=\"firstName\">First Name *</label> <input type=\"text\" id=\"firstName\" name=\"firstName\" required pattern=\".*\\S.*\" title=\"First name cannot be empty or whitespace only\" placeholder=\"Enter first name\"></div><div class=\"form-group\"><label for=\"middleName\">Middle Name</label> <input type=\"text\" id=\"middleName\" name=\"middleName\" placeholder=\"Enter middle name (optional)\"></div><div class=\"form-group\"><label for=\"lastName\">Last Name *</label> <input type=\"text\" id=\"lastName\" name=\"lastName\" required pattern=\".*\\S.*\" title=\"Last name cannot be empty or whitespace only\" placeholder=\"Enter last name\"></div></div><div class=\"form-row\"><div class=\"form-group\"><label for=\"sex\">Sex</label> <select id=\"sex\" name=\"sex\"><option value=\"\">-- Select Sex --</option> <option value=\"M\">M</option> <option value=\"F\">F</option></select></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "</div></div><div class=\"form-group\"><label for=\"retypePassword\">Retype Password *</label><div class=\"password-wrapper\"><input type=\"password\" id=\"retypePassword\" name=\"retypePassword\" required minlength=\"8\" maxlength=\"32\" placeholder=\"Re-enter password\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "</div></div><div class=\"form-row-3\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "\"></div></div></div></div><button type=\"submit\" id=\"submitBtn\" hx-indicator=\"Registering teacher...\">Register Teacher</button></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if loggedIn {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<div class=\"logs-section\"><h3>Logs and Errors</h3><div id=\"logOutput\">Waiting for submission...</div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "<div id=\"logOutput\" style=\"display: none;\"></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
