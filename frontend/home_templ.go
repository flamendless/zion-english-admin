...
func DashboardStatLinkRow(label string, href string, count int64, tooltip string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if count > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 192, Col: 16}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 192, Col: 63}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 193, Col: 44}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 195, Col: 64}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 202, Col: 63}
			}
...
func DashboardSectionedCurrencyStatCard(label string, adminOnly bool, sections []DashboardCurrencySection) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if adminOnly {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 212, Col: 35}
			}
		...
		for _, section := range sections {
			...
			if section.Title != "" {
				if section.AdminOnly {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 220, Col: 54}
					}
			...
			for _, total := range section.Totals {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 225, Col: 89}
				}
...
func DashboardStats(data DashboardData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if auth.HasAdminAccess(data.Role) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 285, Col: 93}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 286, Col: 110}
			}
		...
		if data.Role == auth.RoleTeacher {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 292, Col: 38}
			}
		...
		if data.Role == auth.RoleTeacher || data.Role == auth.RoleTester {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 300, Col: 69}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 309, Col: 138}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/home.templ`, Line: 310, Col: 168}
		}
