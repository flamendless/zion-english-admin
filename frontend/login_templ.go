...
func Login() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/login.templ`, Line: 139, Col: 44}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var3))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" alt=\"Zion English\" class=\"login-logo\"><h1 class=\"login-title\">Login</h1><div id=\"loginError\" class=\"login-error\"></div><div id=\"loginSuccess\" class=\"login-success\"></div><form><div class=\"form-group\"><label for=\"email\">Email</label> <input type=\"email\" name=\"email\" required placeholder=\"Enter your email\"></div><div class=\"form-group\"><label for=\"password\">Password</label><div class=\"password-wrapper\"><input type=\"password\" id=\"password\" name=\"password\" required placeholder=\"Enter your password\"> <button type=\"button\" class=\"password-toggle\" onclick=\"togglePassword()\">Show</button></div></div><div class=\"form-group\" style=\"text-align: center;\"><button hx-post=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/login.templ`, Line: 168, Col: 41}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "\" hx-target=\"#loginError\" hx-swap=\"innerHTML\">Login</button></div></form><div class=\"login-flam\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
