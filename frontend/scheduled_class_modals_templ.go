...
func EditScheduledClassModalForm(data EditScheduleData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-secondary scheduled-class-modal-close\">Cancel</button> <button type=\"submit\" class=\"btn\" id=\"editScheduledClassSubmitBtn\">Save Changes</button></div></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
