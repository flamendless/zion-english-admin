...
func ProcessingLogs(data ProcessingLogData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = ListFilterForm(data.FilterPath, data.Query, "", "", "", "", "", "", data.StartDate, data.EndDate, false, false, false, true, false, "", false, "", false, false, false, false, data.SortBy, data.SortOrder, ListSortKindProcessingLog, false, "", "", "").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if len(data.Logs) > 0 {
